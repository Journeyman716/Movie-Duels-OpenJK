...
static void CG_BreathPuffsVader(centity_t *cent)
{
	gclient_t *client = cent->gent->client;
	...
	if (cent->gent->client->NPC_class == CLASS_VADER)
	{
		if (cent->gent->health > 50)
		{
			G_SoundOnEnt(cent->gent, CHAN_BODY, "sound/chars/darthvader/misc/breathing.mp3");
		}
		else
		{
			G_SoundOnEnt(cent->gent, CHAN_BODY, "sound/chars/darthvader/misc/breathingdamaged.mp3");
		}
	}
	client->breathPuffTime = cg.time + 3000; // every 3 seconds.
}
...
static void CG_CustomRGBForSaberColor(saber_colors_t color, vec3_t rgb)
{
	int saberNum = 0;
	saberInfo_t *saberInfo = &cg_entities->gent->client->ps.saber[saberNum];
...
void CG_DoPrequelSaber( vec3_t blade_muz, vec3_t blade_tip, vec3_t trail_tip, vec3_t trail_muz, float lengthMax, float radius, saber_colors_t color, int rfx, qboolean doLight, qboolean doTrail, int cnum, int bnum, int saberType )
{
	...
	switch( color )
	{
		...
		case SABER_BLACK:			
			switch( saberType )
			{
				case 1:
					glow = cgs.media.blackSaberGlowShader;
					blade = cgi_R_RegisterShader("Ep1Sabers/saber_lineb");
					break;
				case 2:
					glow = cgs.media.blackSaberGlowShader;					
					blade = cgi_R_RegisterShader("Ep2Sabers/saber_lineb");
					ignite = cgs.media.blackIgniteFlare;
					break;
				case 3:
					glow = cgs.media.blackSaberGlowShader;
					blade = cgi_R_RegisterShader("Ep3Sabers/saber_lineb");
		...
		case SABER_UNSTABLE_RED:			
			switch( saberType )
			{
				case 1:
					glow = cgs.media.redSaberGlowShader;
					blade = cgi_R_RegisterShader("SFX_Sabers/saber_blade_unstable");
					break;
				case 2:
					glow = cgs.media.redSaberGlowShader;					
					blade = cgi_R_RegisterShader("SFX_Sabers/saber_blade_unstable");
	...
	effectradius	= ((radius * 1.6 * v1) + crandoms() * 0.1f)*radiusmult;
	coreradius		= ((radius * 0.4 * v2) + crandoms() * 0.1f)*radiusmult;
...
*/
	...
	if( saberType == 2 || saberType == 3 )
	{
		if( blade_len <= ignite_len )
		{
			...
			if( saberType == 2 || ((saberType == 3)&&( color == SABER_RGB || color == SABER_WHITE )))
			{
				if( saberType == 2 )
				{
					saber.customShader = cgs.media.whiteIgniteFlare;
...
void CG_DoEp1Saber( vec3_t blade_muz, vec3_t blade_tip, vec3_t trail_tip, vec3_t trail_muz, float lengthMax, float radius, saber_colors_t color, int rfx, qboolean doLight, qboolean doTrail, int cnum, int bnum )
{
	...
	switch( color )
	{
		case SABER_RED:
			glow = cgs.media.redEp1GlowShader;
			cgs.media.ep1SaberCoreShader = cgi_R_RegisterShader("Ep1Sabers/saber_core");
		...
		case SABER_BLACK:
			glow = cgs.media.blackSaberGlowShader;
			cgs.media.ep1SaberCoreShader = cgi_R_RegisterShader("Ep1Sabers/saber_lineb");
		...
		case SABER_UNSTABLE_RED:
			glow = cgs.media.redEp1GlowShader;
			cgs.media.ep1SaberCoreShader = cgi_R_RegisterShader("SFX_Sabers/saber_blade_unstable");
			cgs.media.sfxSaberEndShader = cgi_R_RegisterShader("SFX_Sabers/saber_end");
			cgs.media.sfxSaberTrailShader = cgi_R_RegisterShader("SFX_Sabers/saber_trail");
			break;
		default:
...
void CG_DoEp2Saber( vec3_t blade_muz, vec3_t blade_tip, vec3_t trail_tip, vec3_t trail_muz, float lengthMax, float radius, saber_colors_t color, int rfx, qboolean doLight, qboolean doTrail, int cnum, int bnum )
{
	...
	switch( color )
	{
		case SABER_RED:
			glow = cgs.media.redEp2GlowShader;
			cgs.media.ep2SaberCoreShader = cgi_R_RegisterShader("Ep2Sabers/saber_core");
			cgs.media.sfxSaberEndShader = cgi_R_RegisterShader("SFX_Sabers/saber_end");
			cgs.media.sfxSaberTrailShader = cgi_R_RegisterShader("SFX_Sabers/saber_trail");
			igniteRGB[0] = 255.0f;
			igniteRGB[1] = 0.0f;
		...
		case SABER_BLACK:
			glow = cgs.media.blackSaberGlowShader;
			cgs.media.ep2SaberCoreShader = cgi_R_RegisterShader("Ep2Sabers/saber_lineb");
			cgs.media.sfxSaberEndShader = cgi_R_RegisterShader("SFX_Sabers/saber_end_black");
			cgs.media.sfxSaberTrailShader = cgi_R_RegisterShader("SFX_Sabers/saber_trail_black");
			igniteRGB[0] = 64.0f;
			igniteRGB[1] = 64.0f;
		...
		case SABER_UNSTABLE_RED:
			glow = cgs.media.redEp1GlowShader;
			cgs.media.ep2SaberCoreShader = cgi_R_RegisterShader("SFX_Sabers/saber_blade_unstable");
			cgs.media.sfxSaberEndShader = cgi_R_RegisterShader("SFX_Sabers/saber_end");
			cgs.media.sfxSaberTrailShader = cgi_R_RegisterShader("SFX_Sabers/saber_trail");
			igniteRGB[0] = 255.0f;
			igniteRGB[1] = 0.0f;
...
void CG_DoEp3Saber( vec3_t blade_muz, vec3_t blade_tip, vec3_t trail_tip, vec3_t trail_muz, float lengthMax, float radius, saber_colors_t color, int rfx, qboolean doLight, qboolean doTrail, int cnum, int bnum )
{
	...
	switch( color )
	{
		case SABER_RED:
			glow = cgs.media.redEp3GlowShader;
			cgs.media.ep3SaberCoreShader = cgi_R_RegisterShader("Ep3Sabers/saber_core");
			cgs.media.sfxSaberEndShader = cgi_R_RegisterShader("SFX_Sabers/saber_end");
			cgs.media.sfxSaberTrailShader = cgi_R_RegisterShader("SFX_Sabers/saber_trail");
			ignite = cgs.media.redIgniteFlare;
			break;
		...
		case SABER_BLACK:
			glow = cgs.media.blackSaberGlowShader;
			cgs.media.ep3SaberCoreShader = cgi_R_RegisterShader("Ep3Sabers/saber_lineb");
			cgs.media.sfxSaberEndShader = cgi_R_RegisterShader("SFX_Sabers/saber_end_black");
			cgs.media.sfxSaberTrailShader = cgi_R_RegisterShader("SFX_Sabers/saber_trail_black");
			ignite = cgs.media.blackIgniteFlare;
			break;
		case SABER_UNSTABLE_RED:
			glow = cgs.media.redEp1GlowShader;
			cgs.media.ep3SaberCoreShader = cgi_R_RegisterShader("SFX_Sabers/saber_blade_unstable");
			cgs.media.sfxSaberEndShader = cgi_R_RegisterShader("SFX_Sabers/saber_end");
			cgs.media.sfxSaberTrailShader = cgi_R_RegisterShader("SFX_Sabers/saber_trail");
			ignite = cgs.media.redIgniteFlare;
			break;
...
void CG_DoOTSaber( vec3_t blade_muz, vec3_t blade_tip, vec3_t trail_tip, vec3_t trail_muz, float lengthMax, float radius, saber_colors_t color, int rfx, qboolean doLight, qboolean doTrail, int cnum, int bnum )
{
	...
	switch( color )
	{
		...
		case SABER_BLACK:
			glow = cgs.media.blackSaberGlowShader;
			cgs.media.otSaberCoreShader = cgi_R_RegisterShader("SFX_Sabers/saber_blade_black");
			cgs.media.sfxSaberEndShader = cgi_R_RegisterShader("SFX_Sabers/saber_end_black");
			cgs.media.sfxSaberTrailShader = cgi_R_RegisterShader("SFX_Sabers/saber_trail_black");
			break;
		case SABER_UNSTABLE_RED:
			glow = cgs.media.redEp1GlowShader;
			cgs.media.otSaberCoreShader = cgi_R_RegisterShader("SFX_Sabers/saber_blade_unstable");
			cgs.media.sfxSaberEndShader = cgi_R_RegisterShader("SFX_Sabers/saber_end");
			cgs.media.sfxSaberTrailShader = cgi_R_RegisterShader("SFX_Sabers/saber_trail");
			break;
		default:
...
static void CG_AddSaberBladeGo( centity_t *cent, centity_t *scent, refEntity_t *saber, int renderfx, int modelIndex, vec3_t origin, vec3_t angles, int saberNum, int bladeNum )
{
	...
	if (cg_SFXSabers.integer < 1)
	{
			...
			if (cg.time > saberTrail->lastTime + 2 && saberTrail->inAction) // 2ms
			{
				if (saberTrail->inAction && cg.time < saberTrail->lastTime + 300) // if we have a stale segment, don't draw until we have a fresh one
				{
					...
					if (diff <= SABER_TRAIL_TIME * 2)
					{
						...
						else if (cent->gent->client->ps.saber[saberNum].type == SABER_UNSTABLEBLADE
						...
						FX_AddPrimitive((CEffect**)&fx, duration);
					}
				}
		...
		if ((cent->currentState.powerups & (1 << PW_CLOAKED)) || (cent->currentState.powerups & (1 << PW_UNCLOAKING)))
		{
			CG_DoSaber(org_, axis_[0], length, client->ps.saber[saberNum].blade[bladeNum].lengthMax, client->ps.saber[saberNum].blade[bladeNum].radius, client->ps.saber[saberNum].blade[bladeNum].color, renderfx, (qboolean)!noDlight);
		}
		else
		{
			CG_DoSaber(org_, axis_[0], length, client->ps.saber[saberNum].blade[bladeNum].lengthMax, client->ps.saber[saberNum].blade[bladeNum].radius, client->ps.saber[saberNum].blade[bladeNum].color, renderfx, (qboolean)!noDlight);
	...
	else
	{
		...
		else if (!(cent->gent->client->ps.saber[saberNum].type == SABER_SITH_SWORD || client->ps.saber[saberNum].saberFlags2&SFL2_NO_BLADE))
		{
			...
			{
			case 1:
				CG_DoEp1Saber(fx->mVerts[0].origin, fx->mVerts[1].origin, fx->mVerts[2].origin, fx->mVerts[3].origin, (client->ps.saber[saberNum].blade[bladeNum].lengthMax), (client->ps.saber[saberNum].blade[bladeNum].radius), client->ps.saber[saberNum].blade[bladeNum].color, renderfx, (qboolean)(client->ps.saber[saberNum].numBlades < 3 && !(client->ps.saber[saberNum].saberFlags2&SFL2_NO_DLIGHT)), (qboolean)(noDlight == qfalse), cent->currentState.clientNum, saberNum);
				break;
			case 2:
				CG_DoEp2Saber(fx->mVerts[0].origin, fx->mVerts[1].origin, fx->mVerts[2].origin, fx->mVerts[3].origin, (client->ps.saber[saberNum].blade[bladeNum].lengthMax), (client->ps.saber[saberNum].blade[bladeNum].radius), client->ps.saber[saberNum].blade[bladeNum].color, renderfx, (qboolean)(client->ps.saber[saberNum].numBlades < 3 && !(client->ps.saber[saberNum].saberFlags2&SFL2_NO_DLIGHT)), (qboolean)(noDlight == qfalse), cent->currentState.clientNum, saberNum);
				break;
			case 3:
				CG_DoEp3Saber(fx->mVerts[0].origin, fx->mVerts[1].origin, fx->mVerts[2].origin, fx->mVerts[3].origin, (client->ps.saber[saberNum].blade[bladeNum].lengthMax), (client->ps.saber[saberNum].blade[bladeNum].radius), client->ps.saber[saberNum].blade[bladeNum].color, renderfx, (qboolean)(client->ps.saber[saberNum].numBlades < 3 && !(client->ps.saber[saberNum].saberFlags2&SFL2_NO_DLIGHT)), (qboolean)(noDlight == qfalse), cent->currentState.clientNum, saberNum);
				break;
			case 4:
				...
				break;
			case 5:
				CG_DoOTSaber(fx->mVerts[0].origin, fx->mVerts[1].origin, fx->mVerts[2].origin, fx->mVerts[3].origin, (client->ps.saber[saberNum].blade[bladeNum].lengthMax), (client->ps.saber[saberNum].blade[bladeNum].radius), client->ps.saber[saberNum].blade[bladeNum].color, renderfx, (qboolean)(client->ps.saber[saberNum].numBlades < 3 && !(client->ps.saber[saberNum].saberFlags2&SFL2_NO_DLIGHT)), (qboolean)(noDlight == qfalse), cent->currentState.clientNum, saberNum);
				break;
			}
		}
				...
				for (int bladeNum = 0; bladeNum < cent->gent->client->ps.saber[saberNum].numBlades; bladeNum++)
				{
					...
					{//saber blade is off
						if (cent->gent->client->ps.saber[saberNum].blade[bladeNum].length > 0)
						{
							...
							{
								cent->gent->client->ps.saber[saberNum].blade[bladeNum].length -= cent->gent->client->ps.saber[saberNum].blade[bladeNum].lengthMax / 10 * cg.frametime / 100 * cg_ignitionSpeedvader.value;
							}
						...
						if ( cent->gent->client->ps.saber[saberNum].blade[bladeNum].length < cent->gent->client->ps.saber[saberNum].blade[bladeNum].lengthMax )
						{
							...
							if (cg.frametime > 0)
							{
								...
								else
								{
									...
									{
									case SS_FAST:
										cent->gent->client->ps.saber[saberNum].blade[bladeNum].length += cent->gent->client->ps.saber[saberNum].blade[bladeNum].lengthMax / 5 * cg.frametime / 100 * cg_ignitionSpeed.value;
										break;
									case SS_STRONG:
										cent->gent->client->ps.saber[saberNum].blade[bladeNum].length += cent->gent->client->ps.saber[saberNum].blade[bladeNum].lengthMax / 10 * cg.frametime / 100 * cg_ignitionSpeed.value;
										break;
									...
									case SS_DUAL:
										...
										break;
									case SS_STAFF:
										cent->gent->client->ps.saber[saberNum].blade[bladeNum].length += cent->gent->client->ps.saber[saberNum].blade[bladeNum].lengthMax / 10 * cg.frametime / 100 * cg_ignitionSpeedstaff.value;
										break;
									default:
										cent->gent->client->ps.saber[saberNum].blade[bladeNum].length += cent->gent->client->ps.saber[saberNum].blade[bladeNum].lengthMax / 10 * cg.frametime / 100 * cg_ignitionSpeed.value;
										break;
