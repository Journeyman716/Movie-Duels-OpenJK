...
{//FIXME: these get fucked by vid_restarts
	...
	rgbTFASaberCoreShader       = re.RegisterShader( "gfx/effects/sabers/blade_TFA");
	...
	redEp1GlowShader            = re.RegisterShader( "Ep1Sabers/red_glowa" );
	orangeEp1GlowShader         = re.RegisterShader( "Ep1Sabers/orange_glowa" );
	yellowEp1GlowShader         = re.RegisterShader( "Ep1Sabers/yellow_glowa" );
	greenEp1GlowShader          = re.RegisterShader( "Ep1Sabers/green_glowa" );
	blueEp1GlowShader           = re.RegisterShader( "Ep1Sabers/blue_glowa" );
	purpleEp1GlowShader         = re.RegisterShader( "Ep1Sabers/purple_glowa" );
	//Episode II Sabers
	ep2SaberCoreShader          = re.RegisterShader( "Ep2Sabers/saber_core" );
	redEp2GlowShader            = re.RegisterShader( "Ep2Sabers/red_glowa" );
	orangeEp2GlowShader         = re.RegisterShader( "Ep2Sabers/orange_glowa" );
	yellowEp2GlowShader         = re.RegisterShader( "Ep2Sabers/yellow_glowa" );
	greenEp2GlowShader          = re.RegisterShader( "Ep2Sabers/green_glowa" );
	blueEp2GlowShader           = re.RegisterShader( "Ep2Sabers/blue_glowa" );
	purpleEp2GlowShader         = re.RegisterShader( "Ep2Sabers/purple_glowa" );
	//Episode III Sabers
	ep3SaberCoreShader          = re.RegisterShader( "Ep3Sabers/saber_core" );
	redEp3GlowShader            = re.RegisterShader( "Ep3Sabers/red_glowa" );
	orangeEp3GlowShader         = re.RegisterShader( "Ep3Sabers/orange_glowa" );
	yellowEp3GlowShader         = re.RegisterShader( "Ep3Sabers/yellow_glowa" );
	greenEp3GlowShader          = re.RegisterShader( "Ep3Sabers/green_glowa" );
	blueEp3GlowShader           = re.RegisterShader( "Ep3Sabers/blue_glowa" );
	purpleEp3GlowShader         = re.RegisterShader( "Ep3Sabers/purple_glowa" );
	//Original Trilogy Sabers
	otSaberCoreShader           = re.RegisterShader( "OTsabers/ot_saberCore" );
	redOTGlowShader             = re.RegisterShader( "OTsabers/ot_redGlow" );
	orangeOTGlowShader          = re.RegisterShader( "OTsabers/ot_orangeGlow" );
	yellowOTGlowShader          = re.RegisterShader( "OTsabers/ot_yellowGlow" );
	greenOTGlowShader           = re.RegisterShader( "OTsabers/ot_greenGlow" );
	blueOTGlowShader            = re.RegisterShader( "OTsabers/ot_blueGlow" );
	purpleOTGlowShader          = re.RegisterShader( "OTsabers/ot_purpleGlow" );
}
...
void UI_DoEp1Saber(vec3_t blade_muz, vec3_t blade_dir, float lengthMax, float radius, saber_colors_t color, saber_crystals_t crystals, int whichSaber)
{
	...
	case SABER_BLACK:
		glow = blackSaberGlowShader;
		blade = ep1SaberCoreShader;
		ep1SaberCoreShader = re.RegisterShader("Ep1Sabers/saber_lineb");
		VectorSet(rgb, .0f, .0f, .0f);
		break;
	case SABER_UNSTABLE_RED:
		glow = redEp1GlowShader;
		blade = ep1SaberCoreShader;
		ep1SaberCoreShader = re.RegisterShader("SFX_Sabers/saber_blade_unstable");
		break;
	default:
		glow = rgbSaberGlowShader;
		blade = ep1SaberCoreShader;
...
void UI_DoEp2Saber(vec3_t blade_muz, vec3_t blade_dir, float lengthMax, float radius, saber_colors_t color, saber_crystals_t crystals, int whichSaber)
{
	...
	case SABER_BLACK:
		glow = blackSaberGlowShader;
		blade = ep2SaberCoreShader;
		ep2SaberCoreShader = re.RegisterShader("Ep2Sabers/saber_lineb");
		VectorSet(rgb, .0f, .0f, .0f);
		break;
	case SABER_UNSTABLE_RED:
		glow = redEp2GlowShader;
		blade = ep2SaberCoreShader;
		ep2SaberCoreShader = re.RegisterShader("SFX_Sabers/saber_blade_unstable");
		break;
	default:
		glow = rgbSaberGlowShader;
		blade = ep2SaberCoreShader;
...
void UI_DoEp3Saber(vec3_t blade_muz, vec3_t blade_dir, float lengthMax, float radius, saber_colors_t color, saber_crystals_t crystals, int whichSaber)
{
	...
	case SABER_BLACK:
		glow = blackSaberGlowShader;
		blade = ep3SaberCoreShader;
		ep3SaberCoreShader = re.RegisterShader("Ep3Sabers/saber_lineb");
		VectorSet(rgb, .0f, .0f, .0f);
		break;
	case SABER_UNSTABLE_RED:
		glow = redEp3GlowShader;
		blade = ep3SaberCoreShader;
		ep3SaberCoreShader = re.RegisterShader("SFX_Sabers/saber_blade_unstable");
		break;
	default:
		glow = rgbSaberGlowShader;
		blade = ep3SaberCoreShader;
...
void UI_DoOTSaber(vec3_t blade_muz, vec3_t blade_dir, float lengthMax, float radius, saber_colors_t color, saber_crystals_t crystals, int whichSaber)
{
	...
	case SABER_BLACK:
		glow = blackSaberGlowShader;
		blade = otSaberCoreShader;
		otSaberCoreShader = re.RegisterShader("SFX_Sabers/saber_blade_black");
		VectorSet(rgb, .0f, .0f, .0f);
		break;
	case SABER_UNSTABLE_RED:
		glow = redOTGlowShader;
		blade = otSaberCoreShader;
		otSaberCoreShader = re.RegisterShader("SFX_Sabers/saber_blade_unstable");
		break;
	default:
		glow = rgbSaberGlowShader;
		blade = otSaberCoreShader;
	...
	effectradius	= ((radius * 1.6) + flrand(0.3f, 1.8f)/* * 0.1f*/)*radiusmult;
	coreradius		= ((radius * 0.4) + flrand(0.1f, 1.0f)/* * 0.1f*/)*radiusmult;
...
saberType_t TranslateSaberType( const char *name )
{
	...
	if (!Q_stricmp(name, "SABER_UNSTABLEBLADE"))
	{
		return SABER_UNSTABLEBLADE;
	}
