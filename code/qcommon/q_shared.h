...
#else
#define PRODUCT_NAME			"MovieDuels"

#define CLIENT_WINDOW_TITLE "MovieDuels (SP)"
#define CLIENT_CONSOLE_TITLE "MovieDuels Console (SP)"
#define HOMEPATH_NAME_UNIX "MD"
#define HOMEPATH_NAME_WIN "MovieDuels (SP)"
#define HOMEPATH_NAME_MACOSX HOMEPATH_NAME_WIN
#endif

#define	BASEGAME "base"
#define OPENJKGAME "MD"
...
public:
	...
	qboolean	dualSabers;
	qboolean	SaberStaff(void) { return (qboolean)(saber[0].type == SABER_STAFF || saber[0].type == SABER_STAFF_UNSTABLE || saber[0].type == SABER_STAFF_SFX || saber[0].type == SABER_STAFF_THIN || (dualSabers && saber[1].type == SABER_STAFF)); };
