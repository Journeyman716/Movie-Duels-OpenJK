...
void CG_RegisterWeapon( int weaponNum ) {
	...
	case WP_SABER:
		...
		for (i = 1; i < 10; i++)
		{
			cgi_S_RegisterSound(va("sound/weapons/saber/saberlock%d.wav", i));
		}
		for ( i = 1; i < 10; i++ )
		{
		...
		cgs.media.orangeOTGlowShader		= cgi_R_RegisterShader( "OTsabers/ot_orangeGlow" );
		cgs.media.yellowOTGlowShader		= cgi_R_RegisterShader( "OTsabers/ot_yellowGlow" );
		cgs.media.greenOTGlowShader			= cgi_R_RegisterShader( "OTsabers/ot_greenGlow" );
		cgs.media.blueOTGlowShader			= cgi_R_RegisterShader( "OTsabers/ot_blueGlow" );
		cgs.media.purpleOTGlowShader		= cgi_R_RegisterShader( "OTsabers/ot_purpleGlow" );
		//Episode I Sabers
		cgs.media.ep1SaberCoreShader		= cgi_R_RegisterShader( "Ep1Sabers/saber_core" );
		cgs.media.redEp1GlowShader			= cgi_R_RegisterShader( "Ep1Sabers/red_glowa" );
		cgs.media.orangeEp1GlowShader		= cgi_R_RegisterShader( "Ep1Sabers/orange_glowa" );
		cgs.media.yellowEp1GlowShader		= cgi_R_RegisterShader( "Ep1Sabers/yellow_glowa" );
		cgs.media.greenEp1GlowShader		= cgi_R_RegisterShader( "Ep1Sabers/green_glowa" );
		cgs.media.blueEp1GlowShader			= cgi_R_RegisterShader( "Ep1Sabers/blue_glowa" );
		cgs.media.purpleEp1GlowShader		= cgi_R_RegisterShader( "Ep1Sabers/purple_glowa" );
		//Episode II Sabers
		cgs.media.ep2SaberCoreShader		= cgi_R_RegisterShader( "Ep2Sabers/saber_core" );
		cgs.media.whiteIgniteFlare			= cgi_R_RegisterShader( "Ep2Sabers/white_ignite_flare" );
		cgs.media.blackIgniteFlare			= cgi_R_RegisterShader( "Ep3Sabers/black_ignite_flare" );
		cgs.media.redEp2GlowShader			= cgi_R_RegisterShader( "Ep2Sabers/red_glowa" );
		cgs.media.orangeEp2GlowShader		= cgi_R_RegisterShader( "Ep2Sabers/orange_glowa" );
		cgs.media.yellowEp2GlowShader		= cgi_R_RegisterShader( "Ep2Sabers/yellow_glowa" );
		cgs.media.greenEp2GlowShader		= cgi_R_RegisterShader( "Ep2Sabers/green_glowa" );
		cgs.media.blueEp2GlowShader			= cgi_R_RegisterShader( "Ep2Sabers/blue_glowa" );
		cgs.media.purpleEp2GlowShader		= cgi_R_RegisterShader( "Ep2Sabers/purple_glowa" );
		//Episode III Sabers
		cgs.media.ep3SaberCoreShader		= cgi_R_RegisterShader( "Ep3Sabers/saber_core" );
		cgs.media.whiteIgniteFlare02		= cgi_R_RegisterShader( "Ep3Sabers/white_ignite_flare" );
		cgs.media.blackIgniteFlare02		= cgi_R_RegisterShader( "Ep3Sabers/black_ignite_flare" );
		cgs.media.redIgniteFlare			= cgi_R_RegisterShader( "Ep3Sabers/red_ignite_flare" );
		cgs.media.greenIgniteFlare			= cgi_R_RegisterShader( "Ep3Sabers/green_ignite_flare" );
		cgs.media.purpleIgniteFlare			= cgi_R_RegisterShader( "Ep3Sabers/purple_ignite_flare" );
		cgs.media.blueIgniteFlare			= cgi_R_RegisterShader( "Ep3Sabers/blue_ignite_flare" );
		cgs.media.orangeIgniteFlare			= cgi_R_RegisterShader( "Ep3Sabers/orange_ignite_flare" );
		cgs.media.yellowIgniteFlare			= cgi_R_RegisterShader( "Ep3Sabers/yellow_ignite_flare" );
		cgs.media.redEp3GlowShader			= cgi_R_RegisterShader( "Ep3Sabers/red_glowa" );
		cgs.media.orangeEp3GlowShader		= cgi_R_RegisterShader( "Ep3Sabers/orange_glowa" );
		cgs.media.yellowEp3GlowShader		= cgi_R_RegisterShader( "Ep3Sabers/yellow_glowa" );
		cgs.media.greenEp3GlowShader		= cgi_R_RegisterShader( "Ep3Sabers/green_glowa" );
		cgs.media.blueEp3GlowShader			= cgi_R_RegisterShader( "Ep3Sabers/blue_glowa" );
		cgs.media.purpleEp3GlowShader		= cgi_R_RegisterShader( "Ep3Sabers/purple_glowa" );
		...
		{//already have it up, let's try to toggle it
			...
			{//player can't activate/deactivate saber when in a cinematic
				...
				if ( cg.predicted_player_state.stats[STAT_HEALTH] > 0
					...
					(&g_entities[cg_entities[0].gent->client->ps.saberEntityNum] != NULL &&
