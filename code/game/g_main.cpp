...
void G_InitCvars( void ) {
	...
	g_saberRealisticImpact = gi.cvar("g_saberRealisticImpact", "0", CVAR_ARCHIVE);//makes collision more realistic
	...
	g_InvertedHolsteredSabers = gi.cvar("g_InvertedHolsteredSabers", "1", CVAR_ARCHIVE);//if 1, saber faces up when holstered not down
